              ...
              while ($row = mysqli_fetch_assoc($listApar)): ?>
                <tr>
                  ...
                  <td data-label="Lokasi">
                    <span><i class="fa-solid fa-location-dot text-danger me-1"></i><?= htmlspecialchars($row['lokasi']) ?></span>
                  </td>
                  <td data-label="Aksi">
    ...
    <div class="modal-box">
      ...
      <form method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="nama_sarana" placeholder="Contoh: APAR 9 KG" required>
        </div>
        <div class="mb-4">
